  ...
  const validate = () => {
    ...
    if (!form.licenseExpiry) {
      ...
      if (selectedDate < today) {
        e.licenseExpiry = t('validation.licenseExpired'); // Already expired or yesterday
      } else if (selectedDate < thirtyDaysFromNow) {
        e.licenseExpiry = t('validation.expiryTooSoon') || "License must be valid for at least 30 days";
      }
    }
