...
//   Clock, TrendingUp, Route, MapPinned
// } from "lucide-react";
...
//                     const destinationLocation = selectedTrip.destinationLocation;
...
//                   {/* Average Speed */}
//                   {/* <div className="p-4 border rounded-xl bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-950/30 dark:to-purple-900/20">
//                     <div className="flex items-center gap-2 mb-1">
//                       <TrendingUp className="h-3.5 w-3.5 text-purple-600" />
//                       <Label className="text-[10px] font-bold text-purple-700 dark:text-purple-400">AVG SPEED</Label>
//                     </div>
...
//                       <Label className="text-[10px] font-bold text-emerald-700 dark:text-emerald-400">REMAING DISTANCE</Label>
//                     </div>
